  ...
  <body style="background-image: linear-gradient(to bottom <?php echo $d;?>, red, blue);">
    <div class="container-fluid">
      <div class="text-center">
        <h1 style="background: -webkit-linear-gradient(<?php echo $f;?>);-webkit-background-clip: text;-webkit-text-fill-color: transparent;" class="greetings">Dr. Ugs Checker</h1>
      </div>
      <div class="row">
